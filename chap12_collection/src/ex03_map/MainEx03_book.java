...
public class MainEx03_book {
	...
	public static void main(String[] args) {
		...
		while(true) {
			...
			try {
				...
				switch(menu) {
				case 1 : addBook();break;    //추가
				case 2 : deleteBook();break; //삭제
				case 3 : printBook();break;  //조회
				case 4 : findBook();break;              //검색
				default :
	...
	/*
	 * 제목을 입력받아서 도서를 libmap에서 제거하기
	 */
	private static void deleteBook() {
		Scanner scan = new Scanner(System.in);
		System.out.println("삭제할 도서의 제목을 입력하세요");
		String title = scan.next();
		//title에 해당하는 도서 정보가 삭제되고, value에 해당하는 Book 객체 리턴
