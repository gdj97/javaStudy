...
public class LoopEx01 {
	public static void main(String[] args) {
		 ...
		 *              i변수는 for문 내부에서 선언되었으므로 for 구문 내에서만 사용이 가능한 지역 변수임
		 * 2. i<=5 : 조건식. 조건식의 결과가 참인 경우 {} 내의 문장을 실행
		 *                 조건식의 결과가 거짓인 경우 for구문이 종료. 반복 종료    
		 * 3. System.out.print(i); 문장 실행  
		 * 4. i++ : i변수의 값이 1 증가됨     
		 *  
		 * 2번으로 다시 반복                  
		 */
		...
		/* 12345
		 * 
		 * 1. (i <= 5) : 조건식. 조건식의 결과가 참인 경우 {} 내의 문장을 실행
