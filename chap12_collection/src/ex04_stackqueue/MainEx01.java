 ...
 *    주요메서드
 *       push(Object) : 객체를 stack에 저장
 *       Object pop() : 객체를 stack에서 제거. 제거된 객체를 리턴
 *       Object peek(): stack에서 조회될 객체 리턴. stack에서 제거 되지 않음
 * Queue : FIFO (First In First Out)
 *    Queue 인터페이스 : LinkedList가 구현 클래스임. List 객체
 *     주요메서드
 *       offer(Object) : 객체를 Queue에 저장
 *       Object poll() : 객체를 Queue에서 제거. 제거된 객체 리턴
 *       Object peek() : Queue에서 조회될 객체 리턴. Queue에서 제거 되지 않음
 */
