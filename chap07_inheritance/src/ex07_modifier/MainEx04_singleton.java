...
/*
 * 생성자의 접근 제한자를 private로 설정가능 => 객체의 갯수를 제한할 수 있음.
 * 객체의 갯수를 한개만 설정
 */
class SingleObject {
...
//		SingleObject o = new SingleObject(); //생성자의 접근제한자가 private이므로 생성자 접근 불가.객체생성불가
		...
		System.out.println("o1.value="+o1.value);
		System.out.println("o2.value="+o2.value);
//		Math m = new Math(); //Math클래스의 생성자가 private임. 객체 생성 불가
		                     //Math클래스의 모든 멤버는 static임.
	}
}
