 ...
 *                       Vector, Hashtable에서만 사용가능  
 *    - hasMoreElements() : 조회할 요소 존재?
...
//		List<Object> vec = new Vector<>();
		vec.add("사과");vec.add("바나나");
		vec.add("체리");
		vec.addElement("망고");  //Vector 구버전의 멤버. List타입의 멤버가 아님
		it = vec.iterator();
		print(it);		
		Enumeration<Object> e = vec.elements(); //List타입의 멤버가 아님
