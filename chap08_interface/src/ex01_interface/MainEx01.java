 ...
 * 2. 인터페이스의 멤버의 접근제한자는 public만 가능. 생략 가능
...
//			System.out.println("남은 잉크량:" + co.ink); //ink멤버는 Complexer 클래스의 멤버임. 
			co.print();
			co.scan();
...
//			System.out.println("남은 잉크량:" + p.ink); //ink멤버는 Complexer 클래스의 멤버임. 
			p.print();
...
//			System.out.println("남은 잉크량:" + s.ink); //ink멤버는 Complexer 클래스의 멤버임. 
...
//			s.receive("02-2222-3333"); //Faxable 의 멤버임
		...
		if(c instanceof Faxable) {
			Faxable f = c; //자동형변환가능
//			System.out.println("남은 잉크량:" + f.ink); //ink멤버는 Complexer 클래스의 멤버임. 
//			f.print(); //Printerable의 멤버임
