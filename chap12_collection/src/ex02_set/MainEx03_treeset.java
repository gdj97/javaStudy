...
public class MainEx03_treeset {
	public static void main(String[] args) {
		...
		set.add("abc");set.add("align");
		set.add("bat");set.add("azz");
		set.add("aZZ");set.add("car");set.add("Car");
		...
		set2.add("abc");set2.add("align");
		set2.add("bat");set2.add("azz");
		set2.add("aZZ");set2.add("car");set2.add("Car");
		System.out.println(set2);
		Set<String> set3 = new TreeSet<>((s1,s2)->0);
		set3.add("abc");set3.add("align");
		set3.add("bat");set3.add("azz");
		set3.add("aZZ");set3.add("car");set3.add("Car");
